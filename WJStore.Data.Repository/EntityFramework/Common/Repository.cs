...
namespace WJStore.Data.Repository.EntityFramework.Common
{
        ...
        where TEntity : class
    {
        ...
        public Repository()
        {
            var contextManager = ServiceLocator.Current.GetInstance<IContextManager<WJStoreContext>>() 
                as ContextManager<WJStoreContext>;
